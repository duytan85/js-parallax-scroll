    ...
    ****************************************/
    ...
    function setParallaxScroll() {
        for (var i=0; i<_parallaxInfo.length; i++) {
            if (!_isTouch) {
                var yPos = Math.round(-((_parallaxInfo[i].elHeight - _windowHeight) / 2) + (_windowPos - _parallaxInfo[i].posTop) / _scrollSpeed);
                var xPos = Math.round(-((_parallaxInfo[i].elWidth - _windowWidth) / 2));
                ...
                var yPos = Math.round(-((_parallaxInfo[i].elHeight - _windowHeight) / 2));
                var xPos = Math.round(-((_parallaxInfo[i].elWidth - _windowWidth) / 2));
